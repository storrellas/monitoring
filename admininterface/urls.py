...
urlpatterns = [
    ...
    url(r'^manage/supervisor/add/$',    EventSupervisorAddView.as_view(),         name='user_add'),
    url(r'^manage/supervisor/edit/(?P<pk>[0-9]+)/$',   EventSupervisorEditView.as_view(),        name='user_edit'),
